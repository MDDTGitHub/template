    ...
    >
      ...
      <el-table-column label="昵称" min-width="150px">
        <template slot-scope="{row}">
          ...
          <el-tag>{{ row.author | typeFilter }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="性别" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.sex }}</span>
      ...
      <el-table-column label="状态" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.status }}</span>
